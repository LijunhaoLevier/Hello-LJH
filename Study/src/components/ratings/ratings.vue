	...
	<div class="ratings" ref="ratings">
        ...
        <div class="overview-right">
          ...
          <div class="delivery-warpper">
			...
			<split></split>
			<ratingselect :selectType="selectType" :onlyContent="onlyContent" :ratings="ratings" @sendMsgToFood="selectRating"></ratingselect>
...
.ratings {
  ...
  .overview {
    display: flex;
    padding: 18px 0;
    /*border-left: #00B43C solid 1px;*/
    .overview-left {
      flex: 0 0 137px;
      padding: 6px 0;
      width: 137px;
      border-right: rgba(7, 17, 27, 0.1) solid 1px;
      text-align: center;
      ...
      .content {
        ...
        .recommend {
          ...
          .item {
            ...
            padding: 0 6px;
            margin: 0 5px 5px 0;
            border: rgba(7, 17, 27, 0.1) solid 1px;
            font-size: 9px;
            border-radius: 3px;
            color: rgb(147, 153, 159);
            background: #FFFFFF;
